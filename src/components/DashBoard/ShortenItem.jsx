...
>
  <div className="flex cursor-pointer items-center gap-1 rounded-md bg-[#3364F7] px-6 py-2 font-semibold text-white shadow-md shadow-slate-500 transition-opacity duration-200 hover:opacity-90">
