...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] max-w-6xl mx-auto lg:px-10 sm:px-8 px-4">
      <div className="lg:flex-row flex-col lg:py-12 pt-12 lg:gap-10 gap-8 flex justify-between items-center">
